...
public class Cliente {
    ...
    private String cpCliente;  // 🚨 Faltaba
    private String poblacionCliente;  // 🚨 Faltaba
    ...
    public Cliente(int id, String nombreCliente, String direccionCliente, String cpCliente, String poblacionCliente,
                   String provinciaCliente, String paisCliente, String cifCliente, String telCliente, String emailCliente,
                   String ibanCliente, double riesgoCliente, double descuentoCliente, String observacionesCliente) {
        this.id = id;
